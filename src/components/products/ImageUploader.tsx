...
interface Props { imageUrl: string; onImageUploaded: (url: string) => void; disabled: boolean; id?: string; label?: string; folder?: "product-images" | "category-images"; required?: boolean; }
export default function ImageUploader({imageUrl, onImageUploaded, disabled, id = "image-upload", label = "Product image", folder = "product-images", required = true}: Props) {
